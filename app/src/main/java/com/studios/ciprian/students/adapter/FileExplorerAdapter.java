...
// adapter : adaptoarele pentru liste in Android
// cu adapter punem o lista de elemente pe ecran
// fiecare clasa din acest package reprezinta liste de note,grupuri,prezente,etc
